...
while True:
    try:
        while True:
            res = pyautogui.locateOnScreen('./icons/chrome.png', confidence=0.30)
            draw_frame(res.left, res.top, res.width, res.height)
            time.sleep(2)
            print("looking...")
    except Exception as e:
        print("No Match Found or No more :V")

#res = pyautogui.locateOnScreen('./icons/chrome.png')
#time.sleep(10)

#print(x,y)
#print(x)
#print(res)
#draw_frame(x, y, 50, 50)
